...
import { Funnel, Menu, Plus, Search } from "@workspace/ui/icons";
...
export function SiteHeader() {
  ...
  return (
    <header className="flex  bg-background/85 backdrop-blur-lg items-center gap-2   w-screen h-14 pr-7 ease-linear ">
